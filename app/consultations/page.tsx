...
const consultations: Consultation[] = [
  {
    ...
    questionnaire: {
      ...
      questions: [
        {
          id: 1,
          text: 'When did you first notice your heart palpitations?',
          type: 'text',
        },
        {
          id: 2,
          text: 'Rate the severity of your palpitations from 1-10',
          type: 'scale',
        },
        {
          id: 3,
          text: 'Select any symptoms you experience with palpitations',
          type: 'checkbox',
          options: ['Dizziness', 'Shortness of breath', 'Chest pain', 'Fatigue', 'Anxiety']
        },
        {
          id: 4,
          text: 'Do the palpitations occur at rest or during activity?',
          type: 'radio',
          options: ['At rest', 'During activity', 'Both', 'Not sure']
        }
      ]
    }
  },
  {
    ...
    questionnaire: {
      ...
      questions: [
        {
          id: 1,
          text: 'What are your average blood glucose readings in the morning?',
          type: 'text',
          answer: '110-130 mg/dL'
        },
        {
          id: 2,
          text: 'How often do you experience hypoglycemia (low blood sugar)?',
          type: 'radio',
          options: ['Never', 'Rarely (1-2 times/month)', 'Sometimes (weekly)', 'Frequently (several times/week)'],
          answer: 'Rarely (1-2 times/month)'
        }
      ]
    }
  },
